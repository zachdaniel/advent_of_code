defmodule Aoc2021.Day17 do
  ...
  def part_1_example() do
    find_highest_possible_y(example_input())
  end

  def part_1() do
    find_highest_possible_y(input())
  end

  def part_2_example() do
    find_all_possible_initial_values(example_input())
  end

  def part_2() do
    find_all_possible_initial_values(input())
  end
