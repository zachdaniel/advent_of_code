defmodule Aoc2021.Day15 do
  ...
  def part_1() do
    shortest_path_total_risk(input())
  end

  def part_1_example() do
    shortest_path_total_risk(example_input())
  end

  def part_2() do
    shortest_path_total_risk(part_2_input())
  end

  def part_2_example() do
    shortest_path_total_risk(part_2_example_input())
  end
